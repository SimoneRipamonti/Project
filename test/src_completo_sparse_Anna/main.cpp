...
{ 
  concentration.compute_phi(i-1,phi1,phi2,phi3,phi4); //Calcolo le phi
  ...
  concentration.one_step_transport_reaction(phi1,phi2,phi3,phi4,rd,rhs,rhs_CO2,method,i,solver,solver2);
  
  concentration.compute_concentration(i,phi1,phi2,phi3,phi4); //Calcolo le Concentrazioni effettive
}
