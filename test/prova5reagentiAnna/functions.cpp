...
//one_step_reaction
void one_step_transport_reaction(Eigen::VectorXd& phi1, Eigen::VectorXd& phi2, Eigen::VectorXd& phi3, Eigen::VectorXd& phi4, const Eigen::VectorXd rd, Eigen::MatrixXd&  M, const Eigen::MatrixXd rhs)
{
  transport_and_reaction(phi1,M,rhs,rd);
  transport_and_reaction(phi2,M,rhs,-2*rd);//no reaction
