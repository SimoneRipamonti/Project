...
It contains the \mbox{\hyperlink{classmuparser__fun}{muparser\+\_\+fun}} class which is defined in the \mbox{\hyperlink{muparser__fun_8hpp_source}{muparser\+\_\+fun.\+hpp}} file.
...
-\/the first one is related to the setting of the solver -\/the second and the third ones are used in the transport\+\_\+decay.\+cpp file in order to set the linear system for the transport and decay problem

\#\+Transport and decay functions It contains the funcitons which define and solve the transport and decay problem 