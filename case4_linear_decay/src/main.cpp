...
int main(int argc, char **argv)
{
    ...
    Data_linear_decay data_linear_decay("data.pot");//We get also the linear decay data because inside its definition there is the initial condition of our tracer
